import{At as S,Bn as tp,Dt as Qf,Et as QI,Fn as qI,Gt as Xl,Hn as up,Mt as SI,O as ct,On as oo,Pn as pl,Qt as Zf,St as Og,Un as ur,Ut as Xf,W as xa,Xt as ZI,Yn as y,Zt as ZL,_t as ME,bn as iI,d as La,dn as fc,dt as KI,ht as Ly,i as Cn,kn as op,m as Ou,nn as _p,nt as GI,q as z_,qn as xI,qt as YL,rn as aI,rt as GL,s as En,sn as cE,tr as zf,un as ei,wt as Pe}from"./main.js";import{c as oe,l as rt}from"./chunk-BDw__whk.js";var J=[`*`];var Z=(()=>{class a{labelPosition=`after`;static ɵfac=function(i){return new(i||a)};static ɵcmp=iI({type:a,selectors:[[``,`mat-internal-form-field`,``]],hostAttrs:[1,`mdc-form-field`,`mat-internal-form-field`],hostVars:2,hostBindings:function(i,e){i&2&&up(`mdc-form-field--align-end`,e.labelPosition===`before`)},inputs:{labelPosition:`labelPosition`},ngContentSelectors:J,decls:1,vars:0,template:function(i,e){i&1&&(qI(),GI(0))},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return a})();var ve=(()=>{class a{static ɵfac=function(i){return new(i||a)};static ɵmod=aI({type:a});static ɵinj=pl({imports:[ae,Cn]})}return a})();export{ve as t};