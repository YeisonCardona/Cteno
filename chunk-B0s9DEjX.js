import{$t as ZI,At as Qf,Cn as iI,Dt as Pe,Ft as SI,Gn as up,Jt as Xl,Kn as ur,Kt as Xf,Ln as pl,M as k_,Mn as op,Nt as S,Qn as y,Rn as qI,Tt as Og,U as wn,Un as tp,W as xu,Xn as xI,Xt as YL,_ as Pa,an as _p,at as GI,bt as ME,en as ZL,ir as zf,jn as oo,kt as QI,mn as fc,mt as KI,o as En,on as aI,ot as GL,pn as ei,tn as Zf,u as Ia,un as cE,vt as Ly,w as ct}from"./main.js";import{c as oe,l as rt}from"./chunk-BXSTZOrY.js";var J=[`*`];var Z=(()=>{class a{labelPosition=`after`;static ɵfac=function(i){return new(i||a)};static ɵcmp=iI({type:a,selectors:[[``,`mat-internal-form-field`,``]],hostAttrs:[1,`mdc-form-field`,`mat-internal-form-field`],hostVars:2,hostBindings:function(i,e){i&2&&up(`mdc-form-field--align-end`,e.labelPosition===`before`)},inputs:{labelPosition:`labelPosition`},ngContentSelectors:J,decls:1,vars:0,template:function(i,e){i&1&&(qI(),GI(0))},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return a})();var K=[`switch`];var ee=[`*`];function te(a,v){a&1&&(ei(0,`span`,11),Xl(),ei(1,`svg`,13),Zf(2,`path`,14),fc(),ei(3,`svg`,15),Zf(4,`path`,16),fc()())}var ie=new S(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var p=class{source;checked;constructor(v,t){this.source=v,this.checked=t}};var ae=(()=>{class a{_elementRef=y(ur);_focusMonitor=y(Ia);_changeDetectorRef=y(GL);defaults=y(ie);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new p(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=wn();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new Pe;toggleChange=new Pe;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){y(ct).load(xu);let t=y(new _p(`tabindex`),{optional:!0}),i=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=i.color||`accent`,this.id=this._uniqueId=y(Pa).getId(`mat-mdc-slide-toggle-`),this.hideIcon=i.hideIcon??!1,this.disabledInteractive=i.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new p(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(i){return new(i||a)};static ɵcmp=iI({type:a,selectors:[[`mat-slide-toggle`]],viewQuery:function(i,e){if(i&1&&op(K,5),i&2){let s;QI(s=ZI())&&(e._switchElement=s.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(i,e){i&2&&(Xf(`id`,e.id),zf(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),cE(e.color?`mat-`+e.color:``),up(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,ZL],color:`color`,disabled:[2,`disabled`,`disabled`,ZL],fullWidth:[2,`fullWidth`,`fullWidth`,ZL],disableRipple:[2,`disableRipple`,`disableRipple`,ZL],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:YL(t)],checked:[2,`checked`,`checked`,ZL],hideIcon:[2,`hideIcon`,`hideIcon`,ZL],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,ZL]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[ME([{provide:rt,useExisting:oo(()=>a),multi:!0},{provide:oe,useExisting:a,multi:!0}]),Og],ngContentSelectors:ee,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(i,e){if(i&1&&(qI(),ei(0,`div`,1)(1,`button`,2,0),tp(`click`,function(){return e._handleClick()}),Zf(3,`div`,3)(4,`span`,4),ei(5,`span`,5)(6,`span`,6)(7,`span`,7),Zf(8,`span`,8),fc(),ei(9,`span`,9),Zf(10,`span`,10),fc(),SI(11,te,5,0,`span`,11),fc()()(),ei(12,`label`,12),tp(`click`,function($){return $.stopPropagation()}),GI(13),fc()()),i&2){let s=KI(2);Qf(`labelPosition`,e.labelPosition),Ly(),up(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),Qf(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),zf(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),Ly(9),Qf(`matRippleTrigger`,s)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),Ly(),xI(e.hideIcon?-1:11),Ly(),Qf(`for`,e.buttonId),zf(`id`,e._labelId)}},dependencies:[k_,Z],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return a})();var ve=(()=>{class a{static ɵfac=function(i){return new(i||a)};static ɵmod=aI({type:a});static ɵinj=pl({imports:[ae,En]})}return a})();export{ve as t};