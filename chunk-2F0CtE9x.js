import{Et as Xl,Gt as cE,Hn as qI,J as Pe,K as Og,L as Ly,Mn as op,Mt as ZI,Nt as ZL,Ot as YL,Pt as Zf,Q as QI,Qn as tp,Qt as ei,Rt as _p,b as GL,cr as y,ct as SI,en as fc,er as up,et as Qf,gr as zf,j as KI,jn as oo,or as xI,ot as S,pn as iI,tr as ur,wt as Xf,y as GI,z as ME,zn as pl,zt as aI}from"./chunk-Cm9TeinW.js";import{M as _e,U as ov,a as Bi,d as Fi,l as Er,s as Cs,w as St}from"./main.js";import{a as ee$1,n as We}from"./chunk-BRSAUx-V.js";var J=[`*`];var Z=(()=>{class a{labelPosition=`after`;static ɵfac=function(i){return new(i||a)};static ɵcmp=iI({type:a,selectors:[[``,`mat-internal-form-field`,``]],hostAttrs:[1,`mdc-form-field`,`mat-internal-form-field`],hostVars:2,hostBindings:function(i,e){i&2&&up(`mdc-form-field--align-end`,e.labelPosition===`before`)},inputs:{labelPosition:`labelPosition`},ngContentSelectors:J,decls:1,vars:0,template:function(i,e){i&1&&(qI(),GI(0))},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return a})();var ve=(()=>{class a{static ɵfac=function(i){return new(i||a)};static ɵmod=aI({type:a});static ɵinj=pl({imports:[ae,Er]})}return a})();export{ve as t};